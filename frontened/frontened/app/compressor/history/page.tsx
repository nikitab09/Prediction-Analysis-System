...
export default function CompressorHistoryPage() {
    ...
    const fetchHistory = async () => {
      try {
        const res = await fetch(
          "http://localhost:5050/compressor-history"
        );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          View all previous compressor health predictions.
        </p>
      </div>
