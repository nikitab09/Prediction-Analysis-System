...
import { Send, Minus, ArrowLeft, Zap, Link as LinkIcon } from 'lucide-react'
import { pageStyles } from '../pump/page'

// ── API URLs ─────────────────────────────────────────────
const MOTOR_API_URL =
  process.env.NEXT_PUBLIC_MOTOR_API_URL ?? 'http://127.0.0.1:5050/predict/motor'

const MOTOR_SAVE_URL =
  process.env.NEXT_PUBLIC_MOTOR_SAVE_URL ?? 'http://127.0.0.1/nextjsbackend/save_motor_prediction.php'
        ...
        <div className="page-header">
          ...
          <div className="page-header-text">
            ...
            <p className="page-sub">
              Enter vibration, temperature, and operational data for prediction
            </p>
          </div>
        </div>
          ...
          <div className="card result-card" style={{ borderColor: statusColor + '44' }}>
            ...
            <div className="result-status-row">
              ...
              <div className="status-meta">
                ...
                <span className="meta-value">{result.fault_type}</span>
              </div>
